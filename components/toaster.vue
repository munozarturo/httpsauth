    ...
    <transition-group name="toaster" tag="div" class="fixed bottom-4 right-4 z-50">
        <div v-for="message in messages" :key="message.id"
            ...
            <div class="mr-2 flex-shrink-0">
                ...
                <svg v-else-if="message.type === 'error'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
                <svg v-else-if="message.type === 'info'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
